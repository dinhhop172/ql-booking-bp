        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">All rooms<a href="create.php" class="float-right btn btn-primary">Add new user</a></h4>
                                        ...
                                        <?php foreach(show_all_rooms($conn) as $value) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="../../../controllers/rooms/delete.php?id=<?= $value['id'] ?>" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-delete"></i></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
